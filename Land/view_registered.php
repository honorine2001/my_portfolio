...
<form action="search.php" method="POST">
    <input type="text" name="search" required><input type="submit" value="Search" name="submit">
</form>
<br><br>
    ...
    $query=mysqli_query($conn,"SELECT * FROM all_land");
    ...
    <?php }}
        ...
        echo "<label>No Land Registered</label>";
    } ?>
    </table>
